...
const ui: Translations = {
  en: {
    ...
    "steps.1.description":
      "Talk to our AI, show your ideas, and see the first visualizations come to life.",
    ...
    "steps.3.description":
      "Transparent, clear, and tailored specifically to you.",
  ...
  de: {
    ...
    "steps.3.description":
      "Transparent, klar und individuell auf dich abgestimmt.",
  ...
  it: {
    ...
    "hero.subtitle":
      "Vivi l'Atelier Live di CYO: lusso, maestria e guida personale, in digitale e di persona.",
  ...
  es: {
    ...
    "hero.subtitle":
      "Experimenta el Atelier en Vivo de CYO: lujo, arte y guía personal, digital y personalmente.",
...
También puedes comunicarte con nosotros por texto o voz. Te acompañaremos paso a paso en todo el proceso.`,
    ...
    "steps.3.description":
      "Transparente, claro y adaptado específicamente a ti.",
  ...
  fr: {
   ...
   "assistant.input.placeholder": "Décrivez le bijou de vos rêves.",
    ...
    "steps.3.description":
      "Transparent, clair et spécialement conçu pour vous.",
...
export const normalizeLocale = (locale: string) =>
  (locale in languages ? locale : "en") as LanguageKeys;
